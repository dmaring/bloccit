...
RSpec.describe PostsController, type: :controller do
  ...
  context "guest user" do
    ...
    describe "DELETE destroy" do
      it "returns http redirect" do
        delete :destroy, parms: { topic_id: my_topic.id, id: my_post.id, post: {title: new_title, body: new_body } }
  ...
  context "signed-in-user" do
    ...
    describe "POST create" do
      it "increases the number of Post by 1" do
        expect{ post :create, params: { topic_id: my_topic.id, post: {title: RandomData.random_sentence, body: RandomData.random_paragraph, user: my_user.name } } }.to change(Post,:count).by(1)
      end
    ...
    describe "DELETE destroy" do
      it "deletes the post" do
        ...
        #6, we search the database for a post with an id equal to my_post.id. This returns an Array. We assign the size of the array to count, and we expect count to equal zero. This test asserts that the database won't have a matching post after  destroy is called.
